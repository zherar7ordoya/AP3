...
namespace Integrador_1
{
    ...
    class Concesionario
    {
        ...
        public void ModificarAuto(Auto pAuto)
        {
            try
            {
                ...
                if (pAuto != null)
                {
                    ...
                    {
                        throw new Exception("El auto que intenta modificar no existe !!!");
                    }
        ...
        public void AsignarAuto(Persona pPersona, Auto pAuto)
        {
        ...
        public void QuitarAutoAsignado(Persona pPersona, Auto pAuto)
        {
            try
            {
        ...
        public List<Auto> AutosDeUnaPersona(Persona pPersona)
        {
